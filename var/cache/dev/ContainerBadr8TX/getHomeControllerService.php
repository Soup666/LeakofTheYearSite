...
class getHomeControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Service/TapeService.php';

        $a = ($container->services['doctrine'] ?? $container->getDoctrineService());

        $container->services['App\\Controller\\HomeController'] = $instance = new \App\Controller\HomeController(new \App\Service\TapeService($a), $a);
