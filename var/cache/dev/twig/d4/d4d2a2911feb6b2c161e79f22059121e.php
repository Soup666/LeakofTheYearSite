...
/* artists/backend/add.html.twig */
class __TwigTemplate_4b7bbca95d1c0bdee18a4e5abf06b1e3 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "artists/backend/add.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "artists/backend/add.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "artists/backend/add.html.twig", 1);
...
";
    ...
    public function block_main($context, array $blocks = [])
    {
        ...
        if ((isset($context["updating"]) || array_key_exists("updating", $context) ? $context["updating"] : (function () { throw new RuntimeError('Variable "updating" does not exist.', 18, $this->source); })())) {
            ...
            echo "\" style=\"max-height: 250px; overflow: hidden;\" alt=\"cover\">
            </div>
            <div class=\"col-md\">
                <div class=\"row\">
                    <h1><strong>";
            // line 25
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["artist"]) || array_key_exists("artist", $context) ? $context["artist"] : (function () { throw new RuntimeError('Variable "artist" does not exist.', 25, $this->source); })()), "name", [], "any", false, false, false, 25), "html", null, true);
            echo "</strong></h1>
                </div>
            </div>
        </div>
    ...
    <div class=\"row mb-3\">
        <div class=\"col-md\">
            ";
        // line 34
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 34, $this->source); })()), "name", [], "any", false, false, false, 34), 'label');
        echo "
            ";
        // line 35
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 35, $this->source); })()), "name", [], "any", false, false, false, 35), 'widget', ["attr" => ["class" => "form-control"]]);
        echo "
        </div>
    </div>
    ...
    <div class=\"row mb-3\">
        ...
        <div class=\"col-md\">
            ";
        // line 43
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 43, $this->source); })()), "cover", [], "any", false, false, false, 43), 'label');
        echo "
            ";
        // line 44
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 44, $this->source); })()), "cover", [], "any", false, false, false, 44), 'widget', ["attr" => ["class" => "form-control"]]);
        echo "
        </div>
        <div class=\"col-md\">
            ";
        // line 47
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 47, $this->source); })()), "coverUrl", [], "any", false, false, false, 47), 'label');
        echo "
            ";
        // line 48
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 48, $this->source); })()), "coverUrl", [], "any", false, false, false, 48), 'widget', ["attr" => ["class" => "form-control"]]);
        echo "
        </div>
    </div>
...
";
    ...
    public function block_body_end($context, array $blocks = [])
    {
        ...
        // line 57
        echo "    ";
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 57, $this->source); })()), 'form_end', ["render_rest" => false]);
        echo "
";
    ...
    {
        return "artists/backend/add.html.twig";
    }
    ...
    {
        return array (  273 => 57,  263 => 56,  251 => 53,  243 => 48,  239 => 47,  233 => 44,  229 => 43,  218 => 35,  214 => 34,  209 => 31,  200 => 25,  193 => 21,  189 => 19,  186 => 18,  176 => 17,  164 => 14,  159 => 13,  149 => 12,  125 => 10,  106 => 9,  93 => 6,  83 => 5,  64 => 3,  41 => 1,);
    }
...
{% block header_title %}Artist{% endblock %}
{% block header_pretitle %}{% if updating %}Edit{% else %}Add New{% endif %} Artist{% endblock %}
...
{% block main %}
    {% if updating %}
        <div class=\"row mb-3\">
            <div class=\"col-4\">
                <img src=\"{{ cover }}\" style=\"max-height: 250px; overflow: hidden;\" alt=\"cover\">
            </div>
            <div class=\"col-md\">
                <div class=\"row\">
...
", "artists/backend/add.html.twig", "/var/www/symfony/templates/artists/backend/add.html.twig");
    }
}
