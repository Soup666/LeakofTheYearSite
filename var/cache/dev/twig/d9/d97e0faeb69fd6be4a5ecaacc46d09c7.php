...
/* base.html.twig */
class __TwigTemplate_54aade161b9093cdab8a8a6b04589e19 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 19, $this->source); })()), "user", [], "any", false, false, false, 19)) {
            // line 20
            echo "    ";
            $this->loadTemplate("_partial/navbar.html.twig", "base.html.twig", 20)->display($context);
        }
        // line 22
        echo "
";
...
";
    ...
    public function block_javascript_header($context, array $blocks = [])
    {
        $macros = $this->macros;
        $__internal_5a27a8ba21ca79b61932376b2fa922d2 = $this->extensions["Symfony\\Bundle\\WebProfilerBundle\\Twig\\WebProfilerExtension"];
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "block", "javascript_header"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "block", "javascript_header"));
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "
            ";
        // line 50
        $this->loadTemplate("_partial/flash-messages.html.twig", "base.html.twig", 50)->display($context);
        // line 51
        echo "
            ";
        // line 52
...
";
    ...
    public function block_header_pretitle($context, array $blocks = [])
    {
        ...
        (((twig_get_attribute($this->env, $this->source, ($context["header"] ?? null), "pretitle", [], "any", true, true, false, 34) &&  !(null === twig_get_attribute($this->env, $this->source, ($context["header"] ?? null), "pretitle", [], "any", false, false, false, 34)))) ? (print (twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["header"] ?? null), "pretitle", [], "any", false, false, false, 34), "html", null, true))) : (print ("")));
    ...
    public function block_header_title($context, array $blocks = [])
    {
        ...
        (((twig_get_attribute($this->env, $this->source, ($context["header"] ?? null), "title", [], "any", true, true, false, 38) &&  !(null === twig_get_attribute($this->env, $this->source, ($context["header"] ?? null), "title", [], "any", false, false, false, 38)))) ? (print (twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["header"] ?? null), "title", [], "any", false, false, false, 38), "html", null, true))) : (print ("")));
    ...
    {
        return array (  385 => 66,  367 => 57,  357 => 54,  355 => 53,  345 => 52,  327 => 43,  308 => 38,  289 => 34,  275 => 44,  273 => 43,  267 => 39,  265 => 38,  260 => 35,  258 => 34,  251 => 29,  241 => 28,  223 => 25,  210 => 58,  208 => 57,  204 => 55,  202 => 52,  199 => 51,  197 => 50,  194 => 49,  192 => 28,  188 => 26,  186 => 25,  183 => 24,  173 => 23,  155 => 16,  137 => 10,  119 => 7,  108 => 67,  106 => 66,  101 => 64,  98 => 62,  96 => 23,  93 => 22,  89 => 20,  87 => 19,  83 => 17,  81 => 16,  74 => 13,  71 => 11,  68 => 10,  63 => 7,  55 => 1,);
    }
...
<body>
{% if app.user %}
    {% include '_partial/navbar.html.twig' %}
{% endif %}
...
{% block body %}
    <div class=\"main-content\">
        ...
        <div class=\"container-fluid\">
                ...
                <div class=\"header\">
                    <div class=\"header-body\">
                        <div class=\"row align-items-center\">
                            <div class=\"col\">
                                <h6 class=\"header-pretitle\">
                                    {% block header_pretitle %}{{ header.pretitle ?? \"\" }}{% endblock %}
                                </h6>
            ...
            {% include '_partial/flash-messages.html.twig' %}
