...
/* labels/backend/add.html.twig */
class __TwigTemplate_afaf1b2ce4cc7d7380aa39db1b2bfd51 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "labels/backend/add.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "labels/backend/add.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "labels/backend/add.html.twig", 1);
...
";
    ...
    public function block_header_actions($context, array $blocks = [])
    {
        ...
        // line 13
        echo "    <a href=\"";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("labels");
...
";
        ...
        if ((isset($context["updating"]) || array_key_exists("updating", $context) ? $context["updating"] : (function () { throw new RuntimeError('Variable "updating" does not exist.', 18, $this->source); })())) {
            ...
            <div class=\"col-md\">
                <div class=\"row\">
                    <h1><strong>";
            // line 25
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["label"]) || array_key_exists("label", $context) ? $context["label"] : (function () { throw new RuntimeError('Variable "label" does not exist.', 25, $this->source); })()), "name", [], "any", false, false, false, 25), "html", null, true);
            echo "</strong></h1>
                </div>
            </div>
        </div>
    ...
    ";
        // line 40
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 40, $this->source); })()), "_token", [], "any", false, false, false, 40), 'row');
        echo "
";
    ...
    public function block_body_end($context, array $blocks = [])
    {
        ...
        // line 44
        echo "    ";
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 44, $this->source); })()), 'form_end', ["render_rest" => false]);
        echo "
";
    ...
    {
        return "labels/backend/add.html.twig";
    }
    ...
    {
        return array (  248 => 44,  238 => 43,  226 => 40,  218 => 35,  214 => 34,  209 => 31,  200 => 25,  193 => 21,  189 => 19,  186 => 18,  176 => 17,  164 => 14,  159 => 13,  149 => 12,  125 => 10,  106 => 9,  93 => 6,  83 => 5,  64 => 3,  41 => 1,);
    }
...
{% block header_title %}Label{% endblock %}
{% block header_pretitle %}{% if updating %}Edit{% else %}Add New{% endif %} Label{% endblock %}

{% block header_actions %}
    <a href=\"{{ path('labels') }}\" class=\"btn-light btn me-2\">Back</a>
...
{% block main %}
    {% if updating %}
        <div class=\"row mb-3\">
            ...
            <div class=\"col-md\">
                <div class=\"row\">
                    <h1><strong>{{ label.name }}</strong></h1>
                </div>
            </div>
        </div>
        <hr>
...
", "labels/backend/add.html.twig", "/var/www/symfony/templates/labels/backend/add.html.twig");
    }
}
