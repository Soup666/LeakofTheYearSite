...
class __TwigTemplate_1bd48b7e2eb4e07ea9a17fe1c6d66c06 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_main($context, array $blocks = [])
    {
        ...
        echo "
            ";
        // line 21
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 21, $this->source); })()), "firstName", [], "any", false, false, false, 21), 'widget', ["attr" => ["class" => "form-control"]]);
        echo "
        </div>
    ...
    <div class=\"form-group\">
        ";
        // line 36
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 36, $this->source); })()), "username", [], "any", false, false, false, 36), 'label');
        echo "
        ";
        // line 37
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 37, $this->source); })()), "username", [], "any", false, false, false, 37), 'widget', ["attr" => ["class" => "form-control mb-3"]]);
        echo "
    </div>
    ...
    <div class=\"form-group\">
        ";
        // line 41
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 41, $this->source); })()), "password", [], "any", false, false, false, 41), 'label');
        echo "
        ";
        // line 42
    ...
    <div class=\"form-group\">
        ";
        // line 46
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 46, $this->source); })()), "roleOptions", [], "any", false, false, false, 46), 'label', ["label" => "Roles"]);
        echo "
        ";
        // line 47
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 47, $this->source); })()), "roleOptions", [], "any", false, false, false, 47), 'widget');
        echo "
    </div>
...
";
    ...
    {
        return array (  278 => 54,  268 => 53,  256 => 50,  250 => 47,  246 => 46,  239 => 42,  235 => 41,  228 => 37,  224 => 36,  217 => 32,  213 => 31,  205 => 26,  201 => 25,  194 => 21,  190 => 20,  186 => 18,  176 => 17,  164 => 14,  159 => 13,  149 => 12,  125 => 10,  106 => 9,  93 => 6,  83 => 5,  64 => 3,  41 => 1,);
    }
...
{% block header_pretitle %}{% if updating %}Edit{% else %}Add New{% endif %} User{% endblock %}

{% block header_actions %}
    <a href=\"{{ path('users') }}\" class=\"btn-light btn me-2\">Back</a>
...
{% block main %}
    ...
    <div class=\"form-group\">
        {{ form_label(form.roleOptions, \"Roles\") }}
        {{ form_widget(form.roleOptions) }}
    </div>
...
{% endblock %}
", "users/form.html.twig", "/var/www/symfony/templates/users/form.html.twig");
    }
}
